...
int tolerance= 70; // Sensitivity of the Alarm
...
void setup(){
 ...
 analogWrite(alarmPin, LOW);    // sets the LED to the button's value
...
void ALARM(){
 ...
 digitalWrite(alarmPin, HIGH);    // sets the LED to the button's value
 delay(100);
 digitalWrite(alarmPin, LOW);    // sets the LED to the button's value
}