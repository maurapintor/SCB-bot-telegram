    ...
    def post(self):
        ...
        if text.startswith('/'):
            if text == '/mais3cr3tpa55u0rd':
                ...
                if text.lower() == '/position':
                    ...
                    if result == 200:
                        reply(chat_id, message_id, 'posizione attuale dal ds aggiornato alle')
                ...
                reply(chat_id, message_id, 'Prima o poi doveva accadere. Chi sei? Non ti conosco, 1 fiorino')
        ...
        # CUSTOMIZE FROM HERE
            ...
            if getEnabled(chat_id):
                reply(chat_id, message_id, 'I got your message! (but I do not know how to answer)')
            else:
